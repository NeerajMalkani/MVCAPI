...
//-----------------------------------------------------------------------  
// <copyright file="OAuthTokenProvider.cs" company="Trepup">  
//     Copyright (c) Allow to distribute this code.  
// </copyright>  
// <author>Jaypal Solanki</author>  
//----------------------------------------------------------------------- 
    ...
    public class OAuthTokenProvider : OAuthAuthorizationServerProvider
    {
        public override Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            return Task.Factory.StartNew(() =>
            {
                ...
                var apiValidation = new APIValidationProvider();
                var user = apiValidation.Validate(userName, password);
                if (user != null)
                {
